import numpy as np
from adaptation_to_regime_changes.definitions import theta_good, maximum_duration
...
def p_ot_st_at(a_t):
    if a_t == 0:
        return np.array([[theta_good, 1 - theta_good], [theta_good, theta_good]])
    else:
...
p_o_t_s_t_a_t1 = np.array([[1 - theta_good, theta_good], [theta_good, 1 - theta_good]])
